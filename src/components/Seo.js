...
//           <p>
//             Install our app to use it like snapetube, Just click on add to home
//             screen button and we are all set. Now you can use it like snaptube.
//             (click on share button and select our downloader)
//           </p>
//         </CardContent>
//       </Card>
//       <Card style={{ marginTop: '15px' }}>
